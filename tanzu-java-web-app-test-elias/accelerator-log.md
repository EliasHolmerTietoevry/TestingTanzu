...
```json
{
  "projectName" : "tanzu-java-web-app-test-elias",
  "repositoryPrefix" : "https://github.com/EliasHolmerTietoevry/TestingTanzu"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->https://github.com/E...(truncated)]
