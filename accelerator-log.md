...
```json
{
  "projectName" : "tanzu-web-elias",
  "repositoryPrefix" : "registry.oso.it-partner.com/tap"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->tanzu-web-elias]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.merge.transformations[0].sources[1].<combo>.transformations[2] (ReplaceText)
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->registry.oso.it-part...(truncated)]
